using LinqWebAPI_Project.Authentication;
...
namespace LinqWebAPI_Project
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AuthenticationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnectionString")));
            ...
            {
                swagger.SwaggerDoc("v1", new OpenApiInfo { Title = "LinqWebAPI_Project", Version = "v1" });
